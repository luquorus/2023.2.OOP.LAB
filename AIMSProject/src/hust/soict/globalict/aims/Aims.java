...
public class Aims extends Application {
    ...
    public static void main(String[] args) {
        store = new Store();
        cart = new Cart();
        store.addMedia(new DigitalVideoDisc("Haikyuu!", "Sport", "Unknown", 0, 14.2f));
        store.addMedia(new DigitalVideoDisc("OnePiece", "Shounen-jump", "Oda", 10, 14.2f));
        store.addMedia(new DigitalVideoDisc("Magi: The Kingdom of Magic", "Shounen-jump", "DVD director", 10, 14.3f));
        store.addMedia(new Book("1Q84", "Romance", 15.2f, new ArrayList<String>(Arrays.asList("Murakami Haruki"))));
        store.addMedia(new CompactDisc("Idol!", "Anime OST", 5.2f, "YOASOBI", "YOASOBI"));
        store.addMedia(new CompactDisc("ORANGE", "Movie OST", 4.3f, "Haikyuu!", "SPYAIR"));
        store.addMedia(new CompactDisc("Kessen spirit", "Anime OST", 4.4f, "Haikyuu!", "Honeyworks"));
        store.addMedia(new Book("Anne of Green Gables", "Novel",16.5f, new ArrayList<String>(Arrays.asList(" Lucy Maud Montgomery"))));
        store.addMedia(new Book("Anne of Avolea", "Novel",16.5f, new ArrayList<String>(Arrays.asList(" Lucy Maud Montgomery"))));
